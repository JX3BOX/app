            ...
            <el-collapse v-model="showCollapse">
              <el-collapse-item v-if="favList.length" title="收藏" :name="1">
                <div class="serverbox-list">
                  <div class="serverbox-item" v-for="(serverItem, serverIndex) in favList" :key="serverIndex">
                    <server-card :data="serverItem" :isSaved="true" @clickServer="clickServer"></server-card>
                  </div>
                </div>
              </el-collapse-item>
              <div v-if="list.length">
                <el-collapse-item v-for="(item, index) in list" :key="index" :title="item.zone_name" :name="(index + 2)">
                  <div v-if="item.serverArr" class="serverbox-list">
                    <div class="serverbox-item" v-for="(serverItem, serverIndex) in item.serverArr"
                      :key="serverIndex">
