        ...
        <ul class="m-npc-list" v-if="list && list.length">
            <li v-for="(o, i) in list" class="u-item" :key="o + i">
                <div class="u-npc">
                    ...
                    <div class="u-primary">
                        <div class="u-life">
                            <img class="u-descicon u-descicon-life" svg-inline src="../../assets/img/database/energy.svg" />
                            <b>血量</b>
                            <em>MaxLife</em>
                            <strong>{{ o.MaxLife }}</strong>
                        </div>
                        <div class="u-mana">
                            <img class="u-descicon u-descicon-mana" svg-inline src="../../assets/img/database/energy.svg" />
                            <b>内力</b>
                            <em>MaxMana</em>
                            <strong>{{ o.MaxMana }}</strong>
                        </div>
                        <div class="u-speed" v-if="o.RunSpeed || o.WalkSpeed">
                            <img class="u-descicon u-descicon-speed" svg-inline src="../../assets/img/database/speed.svg" />
                            <b>跑速</b>
                            <em>RunSpeed</em>
                            <strong>{{ o.RunSpeed || o.WalkSpeed }}</strong>
                        </div>
                        <div class="u-touch" v-if="o.TouchRange">
                            <img class="u-descicon u-descicon-touch" svg-inline src="../../assets/img/database/radar.svg" />
                            <b>范围</b>
                            <em>TouchRange</em>
                            <strong>{{ o.TouchRange }}</strong>
                        </div>
                        <div class="u-sense" v-if="o.Sense">
                            <img class="u-descicon u-descicon-sense" svg-inline src="../../assets/img/database/sight.svg" />
                            <b>识破</b>
                            <em>Sense</em>
                            <strong>{{ o.Sense }}</strong>
                        </div>
                        <div class="u-dodge" v-if="o.Dodge">
                            <img class="u-descicon u-descicon-dodge" svg-inline src="../../assets/img/database/miss.svg" />
                            <b>闪避</b>
                            <em>Dodge</em>
                        ...
                        <div class="u-shield">
                            <img class="u-descicon u-descicon-shield" svg-inline src="../../assets/img/database/shield.svg" />
                            <b>防御</b>
                            <em>Shield</em>
                            <span class="u-sitem">
                                外功防御
                        ...
                        <div class="u-critical">
                            <img class="u-descicon u-descicon-attack" svg-inline src="../../assets/img/database/attack.svg" />
                            <b>会心</b>
                            <em>Critical</em>
                            <span class="u-sitem">
                                外功会心
                        ...
                        <div class="u-attack">
                            <img class="u-descicon u-descicon-attack" svg-inline src="../../assets/img/database/target.svg" />
                            <b>命中</b>
                            <em>Attack</em>
                            <span class="u-sitem">
                                外功命中
