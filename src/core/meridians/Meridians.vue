...
<!--                slot="logo"-->
<!--                svg-inline-->
<!--                src="../../assets/img/logos/jingmai.svg"-->
<!--            />-->
        </Breadcrumb>
            ...
            <div class="m-meridians">
                ...
                <div class="m-meridians-content">
                    ...
                    <div class="m-meridians-preview">
                        <div class="content">
                            <p v-for="(item, index) of preview" :key="index">
                                {{item}}
                            </p>
                        </div>
...
export default {
    ...
    data: function() {
        return {
            zhumai: [
                {name: '任脉·会阴', id: '60', class: 'renmai', requireSuccess: true},
                {name: '督脉·长强', id: '91', class: 'dumai'},
                {name: '带脉·五枢', id: '118', class: 'daimai'},
                {name: '冲脉·气冲', id: '156', class: 'chongmai'},
            ],
            mai: [
                {name: '任脉分之一：玉堂', content:'修行方向：基础能力', title: '玉堂', class: 'idx-yutang idx-ap1', type: 1, state: 0, },
                {name: '任脉分之二：曲骨', content:'修行方向：基础能力', title: '曲骨', class: 'idx-qugu idx-ap2', type: 2, state: 0},
                {name: '督脉分支二：悬枢', content:'修行方向：辅助能力', title: '悬枢', class: 'idx-xuanshu idx-ap2', type: 3, state: 0},
                {name: '督脉分支一：命门', content:'修行方向：辅助能力', title: '命门', class: 'idx-mingmen idx-ap1', type: 4, state: 0},
                {name: '督脉分之三：腰俞', content:'修行方向：辅助能力', title: '腰俞', class: 'idx-yaoshu idx-ap3', type: 5, state: 0},
                {name: '带脉分之一：天冲', content:'修行方向：外功能力', title: '天冲', class: 'idx-tianchong idx-ap1', type: 6, state: 0},
                {name: '带脉分之二：维道', content:'修行方向：外功能力', title: '维道', class: 'idx-weidao idx-ap3', type: 7, state: 0},
                {name: '冲脉分之二：大赫', content:'修行方向：内功能力', title: '大赫', class: 'idx-dahe idx-ap3', type: 8, state: 0},
                {name: '冲脉分之一：横骨', content:'修行方向：内功能力', title: '横骨', class: 'idx-henggu idx-ap1', type: 9, state: 0},
                {name: '经脉寰通：奇穴', content: '修行方向：综合能力', content1: '此奇门绝穴，可贯通神形。达天人之至境，得无双之绝学。', class: 'idx-qixue idx-ap3', title: '奇穴', type: 10, state: 0},
            ],
            detailData: {},
            previewType: 0,
            float: {},
        ...
        init() {
            ...
            define.forEach(item => {
                if (item.requireNode.length > 0) {
                    item.requireNode = item.requireNode.reduce(function (a, b) { return a.concat(b)} )
                }
                if (item.name === '任脉·会阴') {
