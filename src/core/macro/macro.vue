                                    ...
                                    >
                                        ...
                                        <el-row :gutter="6">
                                            <el-col :span="16">
                                                ...
                                                >
                                                    <el-option label="存在增减益效果" value="buff"></el-option>
                                                    <el-option label="增减益效果层数" value="buff_level"></el-option>
                                                    <el-option label="不存在某增减益效果" value="nobuff"></el-option>
                                                    <el-option label="增减益效果持续时间" value="bufftime"></el-option>
