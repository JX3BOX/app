                        ...
                        <div class="m-col m-col-left">
                            <h2 class="u-subtitle">
                                <img
                                    class
                                    svg-inline
                                    src="../../assets/img/macro/cube1.svg"
                                />快捷插入
                            </h2>
                            <el-form
                                class="u-cmds"
                                            ...
                                            <el-col :span="16">
                                                ...
                                                <el-row :gutter="2">
                                                    <el-col
                                                        :span="10"
                                                        v-if="
                                                            needsConditionParams.subname.includes(
                                                                condition.name
                                                            )
                                                        "
                                                    >
                                                    ...
                                                    <el-col
                                                        :span="7"
                                                        v-if="
                                                            needsConditionParams.relation.includes(
                                                                condition.name
                                                            )
                                                        "
                                                    >
                                                    ...
                                                    <el-col
                                                        :span="7"
                                                        v-if="
                                                            needsConditionParams.value.includes(
                                                                condition.name
                                                            )
                                                        "
                                                    >
                        ...
                        <div class="m-col m-col-right">
                            <h2 class="u-subtitle">
                                <img
                                    class
                                    svg-inline
                                    src="../../assets/img/macro/cube2.svg"
                                />宏编辑区
                            </h2>
                            ...
                            />
                            <div class="u-count">
                                <b :class="{ warning: code.length > 128 }">{{
                                    code.length
                                }}</b>
                                / 128
        ...
        insertLine() {
            ...
            if (this.isConditional) {
                ...
                for (let i = 0; i < this.conditions.length; ++i) {
                    ...
                    if (
                        this.needsConditionParams.subname.includes(
                            condition.name
                        )
                    ) {
                    ...
                    if (
                        this.needsConditionParams.relation.includes(
                            condition.name
                        )
                    ) {
                    ...
                    if (
                        this.needsConditionParams.value.includes(condition.name)
                    ) {
