<template>
    <div id="app">
        ...
        <Breadcrumb
            ...
            :crumbEnable="true"
        >
            <img slot="logo" svg-inline :src="getIcon('sandbox')" />
        </Breadcrumb>
            ...
            <div class="m-sandbox">
                ...
                <div class="m-sandbox-change">
                    <div class="m-alert el-alert el-alert--info is-light">
                        <span>
                            <i class="el-icon-star-on"></i>测试版本欢迎反馈
                            <i class="el-icon-star-on"></i>招募各个区服维护沙盘数据的小伙伴
                        </span>
                ...
                <div class="m-sandbox-box" :style="{ background: `url(${imgbg})` }">
                    ...
                    <div class="m-box">
                        ...
                        <div class="m-box-img">
                            ...
                            <span
                                v-for="camp in maplist"
                                :key="camp.id"
                                :style="camp.name_pinyin | placeImg"
                                class="u-img"
                            >
                        ...
                        <div class="m-box-arr">
                            <span
                                ...
                                :key="item.name"
                                :class="item.name_pinyin"
                            >
                                <template v-if="item.attacks.length > 0">
                                    <img
                                        class="u-img"
                                        v-for="c in item.attacks"
                                        :key="c.id"
                                        :class="c.name_pinyin"
                                        :style="item.name_pinyin | placeAttacks(c.name_pinyin)"
                                        :src="camparr"
                                    />
                                </template>
                                <i v-for="a in item.castles" :key="a.name" :class="a.name_pinyin">
                                    <template v-if="a.attacks.length > 0">
                                        <img
                                            class="u-img"
                                            v-for="c in a.attacks"
                                            :key="c.id"
                                            :class="c.name_pinyin"
                                            :style="a.name_pinyin | placeArr(c.name_pinyin)"
                                            :src="camparr"
                                        />
                                    </template>
                                </i>
                        ...
                        <div class="m-box-camp">
                            <span
                                v-for="item in place.list"
                                :key="item.id"
                                class="u-img"
                                :style="item.name_pinyin | placeCamp"
                            >
                        ...
                        <div class="m-box-name">
                            ...
                            >
                                <div class="u-box">
                                    ...
                                    <div
                                        class="u-log"
                                        @click="showlog(item.id, item.name, item.name_pinyin, item.description, item.link)"
                                    >
                                ...
                                <div
                                    slot="reference"
                                    :class="item.name_pinyin"
                                    :style="item.name_pinyin | placeName"
                                    class="u-img"
                                    @click="showlog(item.id, item.name, item.name_pinyin, item.description, item.link)"
                                >
